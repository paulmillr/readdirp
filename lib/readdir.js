...
function readdir(opts, callback1, callback2) {
    ...
    if (utl.isUndefined(callback2)) {
        ...
        allFilesProcessed = callback1;
    } else {
        fileProcessed = callback1;
        allFilesProcessed = callback2;
    }
    ...
    readdirRec(opts.root, 0, function () { 
        ...
        if (errors.length > 0) {
            allFilesProcessed(errors, readdirResult); 
        } else {
            allFilesProcessed(null, readdirResult);
        }
    });
}
